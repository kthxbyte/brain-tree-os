...
1. Use run_shell_command to run `brain-tree-os home` to get the home directory
2. Use read_file on `<home>/.braintree-os/brains.json` to see if this brain is already registered
...
If the brain is NOT registered, use run_shell_command to run:
