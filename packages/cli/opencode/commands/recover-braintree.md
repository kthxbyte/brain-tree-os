...
description: Use when the user wants to recover or register a brain-tree-os project in the brain viewer after migrating or copying the brain files to a new location. Scans the current directory or specified path for brain files and registers them automatically.
agent: build
---

**You are now executing the recover-braintree skill. This helps recover a brain after migrating or copying brain files to a new system.**
